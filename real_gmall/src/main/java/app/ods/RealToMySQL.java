...
public class RealToMySQL {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.setStateBackend(new FsStateBackend("hdfs://hadoop100:9000/gmallflinkCDC"));
        // 设置超时
        ...
        stringDataStreamSource.addSink(new FlinkKafkaProducer<String>(topic, new SimpleStringSchema(), properties));
        env.execute();
